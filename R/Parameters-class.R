...
#'   \item{\code{md}:}{Numeric scalar. Number of internal weight classes}
...
setGeneric("getscaleWinf", function(object) {
  standardGeneric("getscaleWinf")
})
setMethod("getscaleWinf", "Parameters", function(object) {
  return(object@scaleWinf)
})
setGeneric("getscaleFm", function(object) {
  standardGeneric("getscaleFm")
})
setMethod("getscaleFm", "Parameters", function(object) {
  return(object@scaleFm)
})
setGeneric("getscaleA", function(object) {
  standardGeneric("getscaleA")
})
setMethod("getscaleA", "Parameters", function(object) {
  return(object@scaleA)
})
setGeneric("getscalen", function(object) {
  standardGeneric("getscalen")
})
setMethod("getscalen", "Parameters", function(object) {
  return(object@scalen)
})
setGeneric("getscaleeta_F", function(object) {
  standardGeneric("getscaleeta_F")
})
setMethod("getscaleeta_F", "Parameters", function(object) {
  return(object@scaleeta_F)
})
setGeneric("getscaleeta_m", function(object) {
  standardGeneric("getscaleeta_m")
})
setMethod("getscaleeta_m", "Parameters", function(object) {
  return(object@scaleeta_m)
})
setGeneric("getscalea", function(object) {
  standardGeneric("getscalea")
})
...
setGeneric("getscaleepsilon_a", function(object) {
  standardGeneric("getscaleepsilon_a")
})
setMethod("getscaleepsilon_a", "Parameters", function(object) {
  return(object@scaleepsilon_a)
})
setGeneric("getscaleepsilon_r", function(object) {
  standardGeneric("getscaleepsilon_r")
})
setMethod("getscaleepsilon_r", "Parameters", function(object) {
  return(object@scaleepsilon_r)
})
setGeneric("getscaleeta_S", function(object) {
  standardGeneric("getscaleeta_S")
})
setMethod("getscaleeta_S", "Parameters", function(object) {
  return(object@scaleeta_S)
})
setGeneric("getscaleWfs", function(object) {
  standardGeneric("getscaleWfs")
})
setMethod("getscaleWfs", "Parameters", function(object) {
  return(object@scaleWfs)
})
setGeneric("getscaleu", function(object) {
  standardGeneric("getscaleu")
})
setMethod("getscaleu", "Parameters", function(object) {
  return(object@scaleu)
})
setGeneric("getscaleM", function(object) {
  standardGeneric("getscaleM")
})
setMethod("getscaleM", "Parameters", function(object) {
  return(object@scaleM)
})
...
##' @rdname Winf-methods
##' @export
setGeneric("Winf<-", function(object, value) {
  standardGeneric("Winf<-")
})
...
plot.Parameters <- function(x, xlim = c(0.001, 1), ...) {
  p <- getParams(x)
  plot.default(p$w / p$Winf, p$N * (p$w^2),
    log = "xy",
...
setMethod(
  "plotFit", c("Parameters", "numeric", "missing"),
  function(object, data, ...) {
    plotFit(object, data, FALSE, ...)
  }
)
...
setMethod(
  "plotFit", c("Parameters", "data.frame", "missing"),
  function(object, data, ...) {
    plotFit(object, data, FALSE, ...)
  }
)
...
setMethod(
  "plotFit", c("Parameters", "numeric", "logical"),
  function(object, data, add, ...) {
    p <- getParams(object)
    if (add == FALSE) {
      plot(p$w, p$pdfN.approx(p$w),
        type = "l",
...
setMethod(
  "plotFit", c("Parameters", "data.frame", "logical"),
  function(object, data, add, ...) {
...
##' @export
setGeneric("plotGrowth", function(object, ...) {
  standardGeneric("plotGrowth")
})
##' @aliases plotGrowth,Parameters-methods
setMethod(
  "plotGrowth", c("Parameters"),
  function(object, ...) {
    p <- getParams(object)
    ...
    mtext(side = 4, at = ylim.min * 2, text = "% Mature individuals", line = 1.2, col = "lightgrey")
...
setMethod(
  ...
  function(object, ...) {
    ...
    title(xlab = expression(w / W[infinity]))
    title(ylab = expression(Mortality ~ (y^{
      -1
    })), line = 1.4)
...
##' @docType methods
##' @export
setGeneric("getCor", function(object) {
