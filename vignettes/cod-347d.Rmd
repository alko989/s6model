...
plot(inp@years, res$FFmsy, ylim = c(1/11,11), log = "y", type = "l", lwd = 3)
abline(h = 1, lty = 2, lwd = 2)
addIces("cod-347d", col = "darkgrey", lwd = 3)
plot(inp@years, res$ssb, type = "l", lwd = 3)
addIces("cod-347d", what = "SSB", lwd = 3)
```
